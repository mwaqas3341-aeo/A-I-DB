...
const PUB_EDITABLE_FIELDS = [
  ...
  { header: 'Latitude', col: 'latitude',            hint: 'Latitude (Number Only)',                                                                        id: 'pub_Lat',         type: 'number' },
  { header: 'Longitude', col: 'longitude',           hint: 'Longitude (Number Only)',                                                                        id: 'pub_Long',        type: 'number' },
  { header: 'Uc Name', col: 'uc_name',                                                                                                                     id: 'pub_UCName' },
  { header: 'Uc No.', col: 'uc_no',              hint: 'Uc No. (Number Only)',                                                                           id: 'pub_UCNo',        type: 'number' },
  { header: 'Na', col: 'na_no',                  hint: 'Na (Number Only)',                                                                               id: 'pub_NA',          type: 'number' },
  { header: 'Pp', col: 'pp_no',                  hint: 'Pp (Number Only)',                                                                               id: 'pub_PP',          type: 'number' },
  { header: 'Kanal', col: 'kanal',               hint: 'Kanal (Number Only)',                                                                            id: 'pub_Kanal',       type: 'number',  oninput: 'calcPubLand()' },
  { header: 'Marlas', col: 'marlas',              hint: 'Marlas (Number Only)',                                                                           id: 'pub_Marla',       type: 'number',  oninput: 'calcPubLand()' },
  { header: 'Sarsai', col: 'sarsai',              hint: 'Sarsai (Number Only)',                                                                           id: 'pub_Sarsai',      type: 'number',  oninput: 'calcPubLand()' },
  { header: 'Total Area Square Feet', col: 'total_area_sqft', hint: 'Total Area Square Feet (Auto Calculated by converting Kanal to Square Feets, marlas To square feet and sarsai and adding them together)', id: 'pub_TotalArea', readonly: true },
  { header: 'Total Covered Area Square Feet', col: 'total_covered_area_sqft', hint: 'Total Covered Area Square Feet (Number Only)',                                        id: 'pub_Covered',     type: 'number',  oninput: 'calcPubUncovered()' },
  { header: 'Total Uncovered Area Square Feet', col: 'total_uncovered_area_sqft', hint: 'Total Uncovered Area Square Feet (Number Only) Auto Calculated',                    id: 'pub_Uncovered',   readonly: true },
  { header: 'Total rooms', col: 'total_rooms',         hint: 'Total rooms (Number Only)',                                                                      id: 'pub_Rooms',       type: 'number',  oninput: 'calcPubRooms()' },
  { header: 'Used For Teaching', col: 'used_for_teaching',   hint: 'Used For Teaching (Number Only)',                                                                id: 'pub_Teaching',    type: 'number',  oninput: 'calcPubRooms()' },
  { header: 'Non Teaching Activities', col: 'non_teaching_activities', hint: 'Non Teaching Activities (Number Only)',                                                      id: 'pub_NonTeaching', readonly: true },
  { header: 'Total Washrooms', col: 'total_washrooms',     hint: 'Total Washrooms (Number Only)',                                                                  id: 'pub_Washrooms',   type: 'number' },
  { header: 'Electricity Source', col: 'electricity_source',  hint: 'Electricity Source (Wapda, Solar, Both)',                                                        id: 'pub_Elect',       type: 'select',  options: ['Wapda', 'Solar', 'Both'] },
  { header: 'Boundary Wall', col: 'boundary_wall_status',       hint: 'Boundary Wall (Complete/Partial)',                                                               id: 'pub_BWStatus',    type: 'select',  options: ['Complete', 'Partial'], onchange: 'handlePubBW()' },
  { header: 'Required Boundary Wall', col: 'required_boundary_wall', hint: 'Required Boundary Wall (Number Only) — only applies if Partial',                              id: 'pub_BWFeet',      type: 'number',  hidden: true },
  { header: 'Total Furniture', col: 'total_furniture',     hint: 'Total Furniture (Write no of students for which available) (Number Only)',                       id: 'pub_Furniture',   type: 'number' },
  { header: 'Total Enrollment', col: 'total_enrollment',    hint: 'Total Enrollment (Number Only)',                                                                 id: 'pub_Enroll',      type: 'number',  oninput: 'calcPubLand()' },
  { header: 'School Category', col: 'school_category',     hint: 'School Category (Auto Calculated on Front End)',                                                 id: 'pub_Category',    readonly: true },
  { header: 'ECCE Room Available', col: 'ecce_room_available', hint: 'Is ECCE Room Available (Yes/No)',                                                                id: 'pub_ECCEAvail',   type: 'select',  options: ['Yes', 'No'], onchange: 'handlePubECCE()' },
  { header: 'ECCE Under Project', col: 'ecce_under_project',  hint: 'Under Project — only applies if ECCE Room Available is Yes',                                    id: 'pub_ECCEProject', type: 'select',  options: ['PHCIP', 'QAED', 'Prepared by School', 'Other'], hidden: true },
  { header: 'Caregiver Name', col: 'ecce_caregiver_name',      hint: 'Care Giver Name — only applies if ECCE Room Available is Yes',                                  id: 'pub_CGName',      hidden: true },
  { header: 'Caregiver Gender', col: 'ecce_caregiver_gender',    hint: 'Care Giver Gender — only applies if ECCE Room Available is Yes',                                 id: 'pub_CGGender',    type: 'select',  options: ['Male', 'Female'], hidden: true },
  { header: 'Caregiver CNIC', col: 'ecce_caregiver_cnic',      hint: 'Care Giver CNIC — only applies if ECCE Room Available is Yes',                                   id: 'pub_CGCnic',      hidden: true },
  { header: 'Caregiver Cell No', col: 'ecce_caregiver_cell_no',   hint: 'Care Giver Cell No — only applies if ECCE Room Available is Yes',                                id: 'pub_CGCell',      hidden: true },
  { header: 'Bank Name', col: 'bank_name',                                                                                                                   id: 'pub_Bank' },
