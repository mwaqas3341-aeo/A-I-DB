...
const systemNotes = [
  ...
  { text: "Automated process of marking the an employee retired on attaining age of 60 years.If your employee is missing check the Retirements menu for verification.", isNew: true },
