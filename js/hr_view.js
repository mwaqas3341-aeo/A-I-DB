...
function openHrMenu(btn, idx) {
  ...
  if (isStaff) {
    ...
    items += `
      ...
      <button type="button" class="hr-action-item" onclick="openMutualTransferModal(hrFilteredResults[${idx}]); hrActiveMenu&&hrActiveMenu.remove(); hrActiveMenu=null;">🔁 Mutual Transfer</button>
      <button type="button" class="hr-action-item" onclick="openTdAssignModal(hrFilteredResults[${idx}]); hrActiveMenu&&hrActiveMenu.remove(); hrActiveMenu=null;">🕒 Temporary Duty</button>
